...
impl TopPanel {
    ...
    fn file_menu(&mut self, ui: &mut egui::Ui) {
        // TODO: Merge this with the menu creation
        // both should be generated by a list of tuples like:
        // (Text, Modifier list, Key list, Function)
        for event in &ui.input().events {
            match event {
                egui::Event::Key {
                    ...
                    pressed: true,
                    modifiers,
                } if modifiers.command && !modifiers.shift => unsafe {
                    choose_jff_file();
                },
                egui::Event::Key {
                    key: egui::Key::S,
